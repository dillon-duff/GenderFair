...
function createCircularProgress(containerId, score) {
  ...
  svg.append("path").attr("d", backgroundArc).style("fill", "#ddd");
  ...
  svg.append("path").attr("d", percentArc).style("fill", "orange");
...
const e = document.querySelector("#specificOrganization");
if (e) {
